...
return array(
	'ServerAddress'				=> 'divine-ro.net',				// This value is the hostname:port under which Flux runs. (e.g., example.com or example.com:80)
	'BaseURI'					=> '',						// The base URI is the base web root on which your application lies.
	'InstallerPassword'			=> 'divi123',		// Installer/updater password.
	...
	'SiteTitle'					=> 'Divine-RO FluxCP',	// This value is only used if the theme decides to use it.
	'ThemeName'					=> array('Drawmove_Free_FluxCP_Theme'), // Names of the themes you would like list for use in the footer. Themes are in FLUX_ROOT/themes.
	'DefaultThemeName'		=> 'Drawmove_Free_FluxCP_Theme',
	...
	'SingleMatchRedirectItem'	=> true,					// Same as above, for item module.
	'SingleMatchRedirectMobs'	=> true,					// Same as above, for monster module.
	...
	'MailerFromAddress'			=> 'noreply@divine-ro.net',		// The e-mail address displayed in the From field.
	'MailerFromName'			=> 'Divine-RO',			// The name displayed with the From e-mail address.
	...
	'SessionKey'				=> 'divineroDevSessionData',		// Shouldn't be changed, just specifies the session key to be used for session data.
	...
	'PayPalBusinessEmail'		=> 'arp072@hotmail.com',		// Enter the e-mail under which you have registered your business account.
	...
	'ItemShopItemPerPage'		=> 10,						// The number of items to display per page in the "Item Shop" page.
	...
	'CharRankingLimit'			=> 25,						//
	'GuildRankingLimit'			=> 25,						//
	'ZenyRankingLimit'			=> 25,						//
	'DeathRankingLimit'			=> 25,						//
	'AlchemistRankingLimit'		=> 25,						//
	'BlacksmithRankingLimit'	=> 25,						//
	'HomunRankingLimit'			=> 25,						//
...
// Contact Form
	'ContactFormEmail'			=> 'divine.azriel@gmail.com',				// This email address is where you want the form submissions to be sent.
...
// News Options
	...
	'CMSNewsLimit'				=> 10,						// Number of news items to display
...
// Service Desk
	...
	'MenuItems'		=> array(
		...
		'Donations'		=> array(
			...
			'Donation Shop'		=> array('module' => 'purchase'),
		),
		'Information'	=> array(
			...
			'Whos Online'	=> array('module' => 'character', 'action' => 'online'),
		...
		'Social'		=> array(
			'Join Our Discord'	=> array('exturl' => 'https://discord.gg/BVyzUNe'),
			'Vote for Points' => array('module' => 'voteforpoints'),
			'Our Twitter' => array('exturl' => 'https://twitter.com/DivineRagnarok'),
			'Join Us On Facebook'	=> array('exturl' => 'https://www.facebook.com/DivineRO.net/'),
			'Rate Us On RMS'		=> array('exturl' => 'http://ratemyserver.net/index.php?page=detailedlistserver&serid=19289&itv=6&url_sname=DivineRO'),
		),
		'Service Desk'	=> array(
			'Service Desk'	=> array('module' => 'servicedesk', 'action' => 'staffindex'),
		),
		'Misc. Stuff'	=> array(
			'Account'		=> array('module' => 'account'),
			'Character'	=> array('module' => 'character'),
			...
			'ReInstall'	=> array('module' => 'install', 'action' => 'reinstall'),
			'Send Mail'		=> array('module' => 'mail'),
			'Web Commands'		=> array('module' => 'webcommands'),
